...
public class SysUser extends AbstractDO {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("UserId", getUserId()).append("MobileNo", getMobileNo()).append(
				"HeadUrl", getHeadUrl()).append("Passwd", getPasswd()).append("Balance", getBalance()).append("TicketAmount", getTicketAmount())
				.append("BeanAmount", getBeanAmount()).append("AftersaleTicketFlag", getAftersaleTicketFlag()).append("PlanNotiFlag",
						getPlanNotiFlag()).append("RegTime", getRegTime()).append("LoginTime", getLoginTime()).append("Status", getStatus())
				.toString();
	}
